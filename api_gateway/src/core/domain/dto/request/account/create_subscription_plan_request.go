...
type CreateSubscriptionPlanRequest struct {
	...
	MonthlyPrice   *float64          `json:"monthlyPrice" binding:"omitempty,gte=0"`
	YearlyPrice    *float64          `json:"yearlyPrice" binding:"omitempty,gte=0"`
	...
	Modules        []PlanModuleDto   `json:"modules" binding:"omitempty,dive"`
