// Sales Header Component (authors: QuanTuanHuy, Description: Part of Serp Project)
...
export const SalesHeader: React.FC<SalesHeaderProps> = ({
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      router.push(`/sales/dashboard?search=${encodeURIComponent(searchQuery)}`);
    }
  };
    ...
    >
      <div className='flex h-16 items-center justify-between px-6'>
        ...
        <div className='flex items-center space-x-3'>
          ...
          {/* Notifications */}
          <NotificationButton
            settingsPath='/sales/settings'
            allNotificationsPath='/sales/dashboard'
          />
