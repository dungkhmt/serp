...
public interface IContactService {
    ...
    ContactEntity updateContact(Long id, ContactEntity updates, Long tenantId);
    ...
    Pair<List<ContactEntity>, Long> getContactsByCustomer(Long customerId, Long tenantId, PageRequest pageRequest);
    ...
    ContactEntity setPrimaryContact(Long id, Long tenantId);
